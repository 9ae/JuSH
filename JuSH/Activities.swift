...
let activitiesList = [Activity(user_name: "Finn", day_flag: 1 ,date_time: "Tuesday afternoon", venue_name: "Madison Sq. Park", description: "Walk our dogs", details: "Walk with me and my dog Jake", interested: [])]

let myActsList = [
    Activity(
        user_name: "BMO", day_flag: 1, date_time: "Tonight", venue_name: "X", description: "x", details: "x", interested: [
            User(first_name:"Finn"), User(first_name:"Marceline") ]),
    Activity(
        user_name: "BMO", day_flag: 1, date_time: "Tomorrow Afternoon", venue_name: "Y", description: "xy", details: "xy", interested: [
            User(first_name:"Finn"), User(first_name:"Bubblegum") ])
]